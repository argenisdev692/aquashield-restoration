...
final class ClaimStatusExcelExport implements
    FromQuery,
    WithHeadings,
    WithMapping,
    ShouldAutoSize,
    ...
    WithStyles
{
    ...
    {
        return ['Claim Status', 'Background Color', 'Status', 'Created At', 'Deleted At'];
    }

    /** @param ClaimStatusEloquentModel $row */
    public function map($row): array
    {
        return ClaimStatusExportTransformer::forExcel($row);
    }
