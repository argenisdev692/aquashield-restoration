 ...
 *     @OA\Property(property="claim_number", type="string", nullable=true, example="CLM-XYZ"),
 *     @OA\Property(property="date_of_loss", type="string", nullable=true, example="2024-08-01"),
 *     @OA\Property(property="description_of_loss", type="string", nullable=true),
 *     @OA\Property(property="number_of_floors", type="integer", nullable=true, example=2),
 *     @OA\Property(property="claim_date", type="string", nullable=true, example="2024-08-10"),
 *     @OA\Property(property="work_date", type="string", nullable=true, example="2024-08-15"),
 ...
 *     @OA\Property(property="customer_reviewed", type="boolean", nullable=true, example=false),
...
final class StoreClaimData extends Data
{
