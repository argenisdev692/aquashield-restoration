...
<head>
    ...
    <style>
        ...
        th { background: #f3f4f6; color: #111827; border: 1px solid #d1d5db; padding: 7px; font-size: 9px; text-align: left; }
        td { border: 1px solid #e5e7eb; padding: 7px; font-size: 9px; vertical-align: top; }
...
<body>
    ...
    <div class="footer">AquaShield CRM &mdash; Claims Report</div>
</body>
</html>
