...
$destDir = "c:\Users\Lenovo\Documents\PROYECTOS\AQUASHIELD-CRM\src\Modules\PublicCompanies"
...
# Recursively rename files and directories matching 'Insurance*' -> 'Public*'
...
Write-Host "Done templating PublicCompanies"
